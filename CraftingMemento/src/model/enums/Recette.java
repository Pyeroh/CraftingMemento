...
public enum Recette {
	...
	or3(gold_ingot, 1,new EItem[][] { { gold_nugget, gold_nugget, gold_nugget },{ gold_nugget, gold_nugget, gold_nugget },{ gold_nugget, gold_nugget, gold_nugget } }),
	...
	terre_cuite_blanche(white_stained_clay, 8, new EItem[][] {{ hardened_clay, hardened_clay, hardened_clay },{ hardened_clay, bone_meal, hardened_clay },{ hardened_clay, hardened_clay, hardened_clay } }),
	...
	livre_manuscrit5(written_book, 6, written_book, book_and_quill,book_and_quill, book_and_quill, book_and_quill, book_and_quill),
	livre_manuscrit6(written_book, 7, written_book, book_and_quill,book_and_quill, book_and_quill, book_and_quill, book_and_quill,book_and_quill),
	livre_manuscrit7(written_book, 8,written_book, book_and_quill, book_and_quill, book_and_quill,book_and_quill, book_and_quill, book_and_quill, book_and_quill),
	livre_manuscrit8(written_book, 9, written_book, book_and_quill,book_and_quill, book_and_quill, book_and_quill, book_and_quill,book_and_quill, book_and_quill, book_and_quill),
	cadre(item_frame, 1, new EItem[][] { { stick, stick, stick },{ stick, leather, stick }, { stick, stick, stick } }),

	chaudron(cauldron, 1, new EItem[][] {{ iron_ingot, air, iron_ingot },{ iron_ingot, air, iron_ingot },{ iron_ingot, iron_ingot, iron_ingot } }),
	...
	pierre_lumineuse(glowstone, 1, new EItem[][] {{ air, air, air }, { glowstone_dust, glowstone_dust, air },{ glowstone_dust, glowstone_dust, air } }),
	bloc_de_brique_du_nether(nether_brick_block, 1, new EItem[][] { { air, air, air },{ air, nether_brick, nether_brick },{ air, nether_brick, nether_brick } }),
	barriere_nether(nether_fence, 6, new EItem[][] {{ air, air, air },{ nether_brick, nether_brick, nether_brick },{ nether_brick, nether_brick, nether_brick } }),
	escalier_nether(nether_brick_stairs, 4, new EItem[][] {{ nether_brick, air, air },{ nether_brick, nether_brick, air },{ nether_brick, nether_brick, nether_brick } }),

	/*
	 * ITEMS A COMBINABILITES VARIABLE (DIVERS)
	 */

	lit(bed, 1, new EItem[][] { { air, air, air },{ white_wool, white_wool, white_wool },{ oak_wood, oak_wood, oak_wood } }, true),
	bibliotheque(bookshelf, 1, new EItem[][] {{ oak_wood, oak_wood, oak_wood }, { book, book, book },{ oak_wood, oak_wood, oak_wood } }, true),
	portillon(fence_gate, 1,new EItem[][] { { air, air, air }, { stick, oak_wood, stick },{ stick, oak_wood, stick } }, true),
	panneau(sign,3,new EItem[][] { { oak_wood, oak_wood, oak_wood },{ oak_wood, oak_wood, oak_wood }, { air, stick, air } },true),
	coffre(chest, 1, new EItem[][] {{ oak_wood, oak_wood, oak_wood }, { oak_wood, air, oak_wood },{ oak_wood, oak_wood, oak_wood } }, true),
	coffre_piege(trapped_chest, 1, new EItem[][] { { air, air, air },{ tripwire_hook, chest, air }, { air, air, air } }),
	porte_bois(wood_door, 1, new EItem[][] {{ oak_wood, oak_wood, air },{ oak_wood, oak_wood, air },{ oak_wood, oak_wood, air } }, true),
	jukebox(EItem.jukebox, 1, new EItem[][] { { oak_wood, oak_wood, oak_wood },{ oak_wood, diamond, oak_wood },{ oak_wood, oak_wood, oak_wood } }, true),
	trappe(trap_door, 2, new EItem[][] { { air, air, air },{ oak_wood, oak_wood, oak_wood },{ oak_wood, oak_wood, oak_wood } }, true),
	...
	distributeur(dispenser, 1, new EItem[][] {{ cobblestone, cobblestone, cobblestone },{ cobblestone, bow, cobblestone },{ cobblestone, EItem.redstone, cobblestone } }),
	noteblock(note_block, 1, new EItem[][] {{ oak_wood, oak_wood, oak_wood },{ oak_wood, EItem.redstone, oak_wood },{ oak_wood, oak_wood, oak_wood } }, true),
	rail_booster(powered_rail, 6, new EItem[][] {{ gold_ingot, air, gold_ingot },{ gold_ingot, stick, gold_ingot },{ gold_ingot, EItem.redstone, gold_ingot } }),
	rail_detecteur(detector_rail, 6, new EItem[][] {{ iron_ingot, air, iron_ingot },{ iron_ingot, stone_plate, iron_ingot },{ iron_ingot, EItem.redstone, iron_ingot } }),
	piston_collant(sticky_piston, 1, new EItem[][] { { air, air, air },{ air, slime_ball, air }, { air, EItem.piston, air } }),
	piston(EItem.piston, 1, new EItem[][] {{ oak_wood, oak_wood, oak_wood },{ cobblestone, iron_ingot, cobblestone },{ cobblestone, EItem.redstone, cobblestone } }),
	tnt(EItem.tnt, 1, new EItem[][] {{ gunpowder, sand, gunpowder },{ sand, gunpowder, sand },{ gunpowder, sand, gunpowder } }),
	tnt2(EItem.tnt,1, new EItem[][] { { gunpowder, redsand, gunpowder },{ redsand, gunpowder, redsand },{ gunpowder, redsand, gunpowder } }),
	rail(rails, 16, new EItem[][] { { iron_ingot, air, iron_ingot },{ iron_ingot, stick, iron_ingot },{ iron_ingot, air, iron_ingot } }),
	...
	lampe_redstone(redstone_lamp_off, 1, new EItem[][] {{ air, EItem.redstone, air },{ EItem.redstone, glowstone, EItem.redstone },{ air, EItem.redstone, air } }),
	...
	plaque_pression_sensible(gold_plate, 1, new EItem[][] {{ air, air, air }, { air, air, air },{ gold_ingot, gold_ingot, air } }),
	plaque_pression_lourde(iron_plate, 1, new EItem[][] {{ air, air, air }, { air, air, air },{ iron_ingot, iron_ingot, air } }),
	capteur_solaire(daylight_detector, 1, new EItem[][] {{ glass, glass, glass },{ EItem.quartz, EItem.quartz, EItem.quartz },{ oakwood_slab, oakwood_slab, oakwood_slab } }, true),
	entonnoir(hopper, 1, new EItem[][] {{ iron_ingot, air, iron_ingot },{ iron_ingot, chest, iron_ingot },{ air, iron_ingot, air } }),
	rail_activation(activator_rail, 6, new EItem[][] {{ iron_ingot, stick, iron_ingot },{ iron_ingot, redstone_torch_on, iron_ingot },{ iron_ingot, stick, iron_ingot } }),
	droppeur(dropper, 1, new EItem[][] {{ cobblestone, cobblestone, cobblestone },{ cobblestone, air, cobblestone },{ cobblestone, EItem.redstone, cobblestone } }),

	repeteur(repeater, 1, new EItem[][] { { air, air, air },{ redstone_torch_on, EItem.redstone, redstone_torch_on },{ stone, stone, stone } }),
	comparateur(redstone_comparator,1, new EItem[][] { { air, redstone_torch_on, air },{ redstone_torch_on, EItem.quartz, redstone_torch_on },{ stone, stone, stone } }),
	...
	pomme_or(golden_apple_1, 1, new EItem[][] {{ gold_nugget, gold_nugget, gold_nugget },{ gold_nugget, apple, gold_nugget },{ gold_nugget, gold_nugget, gold_nugget } }),
	pomme_or_enchant(golden_apple_2, 1, new EItem[][] {{ gold_block, gold_block, gold_block },{ gold_block, apple, gold_block },{ gold_block, gold_block, gold_block } }),
	...
	carotte_doree(golden_carrot, 1, new EItem[][] {{ gold_nugget, gold_nugget, gold_nugget },{ gold_nugget, carrot, gold_nugget },{ gold_nugget, gold_nugget, gold_nugget } }),
	...
	pioche_fer(iron_pickaxe, 1,new EItem[][] { { iron_ingot, iron_ingot, iron_ingot },{ air, stick, air }, { air, stick, air } }),
	...
	pioche_bois(wood_pickaxe, 1, new EItem[][] {{ oak_wood, oak_wood, oak_wood }, { air, stick, air },{ air, stick, air } }, true),
	...
	pioche_pierre(stone_pickaxe,1, new EItem[][] { { cobblestone, cobblestone, cobblestone },{ air, stick, air }, { air, stick, air } }),
	hache_pierre(stone_axe, 1, new EItem[][] {{ cobblestone, cobblestone, air },{ cobblestone, stick, air }, { air, stick, air } }),
	...
	boussole(compass, 1, new EItem[][] { { air, iron_ingot, air },{ iron_ingot, EItem.redstone, iron_ingot },{ air, iron_ingot, air } }),
	canne_a_peche(fishing_rod, 1, new EItem[][] { { air, air, stick },{ air, stick, string }, { stick, air, string } }),
	montre(watch, 1, new EItem[][] { { air, gold_ingot, air },{ gold_ingot, EItem.redstone, gold_ingot },{ air, gold_ingot, air } }),
	...
	torse_cuir(leather_chestplate, 1, new EItem[][] {{ leather, air, leather },{ leather, leather, leather },{ leather, leather, leather } }),
	jambes_cuir(leather_leggings, 1, new EItem[][] {{ leather, leather, leather },{ leather, air, leather }, { leather, air, leather } }),
	...
	tete_fer(iron_helmet, 1, new EItem[][] { { air, air, air },{ iron_ingot, iron_ingot, iron_ingot },{ iron_ingot, air, iron_ingot } }),
	torse_fer(iron_chestplate, 1, new EItem[][] {{ iron_ingot, air, iron_ingot },{ iron_ingot, iron_ingot, iron_ingot },{ iron_ingot, iron_ingot, iron_ingot } }),
	jambes_fer(iron_leggings, 1, new EItem[][] {{ iron_ingot, iron_ingot, iron_ingot },{ iron_ingot, air, iron_ingot },{ iron_ingot, air, iron_ingot } }),
	pieds_fer(iron_boots, 1, new EItem[][] { { air, air, air },{ iron_ingot, air, iron_ingot },{ iron_ingot, air, iron_ingot } }),

	tete_diamant(diamond_helmet, 1, new EItem[][] {{ air, air, air }, { diamond, diamond, diamond },{ diamond, air, diamond } }),
	torse_diamant(diamond_chestplate, 1, new EItem[][] {{ diamond, air, diamond },{ diamond, diamond, diamond },{ diamond, diamond, diamond } }),
	jambes_diamant(diamond_leggings, 1, new EItem[][] {{ diamond, diamond, diamond },{ diamond, air, diamond }, { diamond, air, diamond } }),
	pieds_diamant(diamond_boots, 1, new EItem[][] { { air, air, air },{ diamond, air, diamond }, { diamond, air, diamond } }),

	tete_or(gold_helmet, 1, new EItem[][] { { air, air, air },{ gold_ingot, gold_ingot, gold_ingot },{ gold_ingot, air, gold_ingot } }),
	torse_or(gold_chestplate, 1, new EItem[][] {{ gold_ingot, air, gold_ingot },{ gold_ingot, gold_ingot, gold_ingot },{ gold_ingot, gold_ingot, gold_ingot } }),
	jambes_or(gold_leggings, 1, new EItem[][] {{ gold_ingot, gold_ingot, gold_ingot },{ gold_ingot, air, gold_ingot },{ gold_ingot, air, gold_ingot } }),
	...
	wagon(minecart, 1, new EItem[][] { { air, air, air },{ iron_ingot, air, iron_ingot },{ iron_ingot, iron_ingot, iron_ingot } }),
	...
	pasteque_scintillante(speckled_melon,1, new EItem[][] { { gold_nugget, gold_nugget, gold_nugget },{ gold_nugget, melon, gold_nugget },{ gold_nugget, gold_nugget, gold_nugget } }),
	...
	potion_splash_faiblesse4(s_p_weakness, fermented_spider_eye, s_p_healing),
	...
	/**
	 * Constructeur à ne pas appeler, permet de construire rapidement et
	 * sans répétition un enum
	 *
	 * @param id
	 ...
	 * @param mid
	 *            Nouveau "Minecraft ID", le nom dans le jeu pour y accéder
	 *            via un /give
	 * @param type
	 ...
	 *
	 * @param recette
	 *            Tableau d'ingrédients, 3x3, tout doit être rempli (même
