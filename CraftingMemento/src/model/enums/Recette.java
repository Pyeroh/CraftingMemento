...
public enum Recette {
	...
	escalier_roche_sable(128, 0, "sandstone_stairs", 4, new EItem[][] {{ sandstone, air, air }, { sandstone, sandstone, air },{ sandstone, sandstone, sandstone } }),
	...
	enclume(145, 0, "anvil", 1, new EItem[][] {{ iron_block, iron_block, iron_block },{ air, iron_ingot, air },{ iron_ingot, iron_ingot, iron_ingot } }),
	...
	alambic(379, 0,"brewing_stand", 1, new EItem[][] { { air, air, air },{ air, blaze_rod, air },{ cobblestone, cobblestone, cobblestone } }),
	...
	pot_fleur(390, 0,"flower_pot", 1, new EItem[][] { { air, air, air },{ clay_brick, air, clay_brick }, { air, clay_brick, air } }),
	...
	bloc_charbon(173, 0, "coal_block", 1, new EItem[][] {{ coal, coal, coal }, { coal, coal, coal },{ coal, coal, coal } }),
	charbon(173, 0, "coal", 9, coal_block),

	bloc_redstone(152, 0, "redstone_block", 1, new EItem[][] {{ EItem.redstone, EItem.redstone, EItem.redstone },{ EItem.redstone, EItem.redstone, EItem.redstone },{ EItem.redstone, EItem.redstone, EItem.redstone } }),
	...
	bloc_lapis_lazuli(41, 0, "lapis_block", 1,new EItem[][] {{ EItem.lapis_lazuli, EItem.lapis_lazuli,EItem.lapis_lazuli },{ EItem.lapis_lazuli, EItem.lapis_lazuli,EItem.lapis_lazuli },{ EItem.lapis_lazuli, EItem.lapis_lazuli,EItem.lapis_lazuli } }),
	lapis_lazuli2(266, 0, "dye", 9, lapis_block),
	...
	porte_fer(330, 0, "iron_door", 1, new EItem[][] {{ iron_ingot, iron_ingot, air },{ iron_ingot, iron_ingot, air },{ iron_ingot, iron_ingot, air } }),
	echelle(65, 0,"ladder", 3, new EItem[][] { { stick, air, stick },{ stick, stick, air }, { stick, air, stick } }),
	coffre_ender(130, 0, "ender_chest", 1, new EItem[][] {{ obsidian, obsidian, obsidian },{ obsidian, eye_of_ender, obsidian },{ obsidian, obsidian, obsidian } }),
