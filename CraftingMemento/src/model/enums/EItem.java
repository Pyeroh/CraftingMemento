...
public enum EItem {
	...
	acacia_wood(5,3,"WOOD",EItemCat.block),
	darkoak_wood(5,4,"WOOD",EItemCat.block),
	...
	public String getName() {
		String name = name();
		if(name.endsWith("glass") || name.endsWith("stained_clay") || name.endsWith("carpet") || name.endsWith("dye")) {
